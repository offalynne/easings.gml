...
global.___EASING.LIST[EASE.LINEAR            ] = function(z){ return z;                                   };
global.___EASING.LIST[EASE.SMOOTHSTEP        ] = function(z){ return z * z * (3 - 2 * z);                 };
global.___EASING.LIST[EASE.SMOOTHERSTEP      ] = function(z){ return z * z * z * (z * (z * 6 - 15) + 10); };
global.___EASING.LIST[EASE.INVERSE_SMOOTHSTEP] = function(z){ return 0.5 - sin(arcsin(1 - 2 * z) / 3);    };

global.___EASING.LIST[EASE.IN_QUAD ] = function(z){ return z * z;             };
global.___EASING.LIST[EASE.IN_CUBIC] = function(z){ return z * z * z;         };
global.___EASING.LIST[EASE.IN_QUART] = function(z){ return z * z * z * z;     };
global.___EASING.LIST[EASE.IN_QUINT] = function(z){ return z * z * z * z * z; };

global.___EASING.LIST[EASE.OUT_QUAD ] = function(z){ return 1 - (1 -z) * (1 -z);  };
global.___EASING.LIST[EASE.OUT_CUBIC] = function(z){ return 1 - power(1 - z, 3);  };
global.___EASING.LIST[EASE.OUT_QUART] = function(z){ return 1 - power(1 - z, 4);  };
global.___EASING.LIST[EASE.OUT_QUINT] = function(z){ return 1 - power(1 - z, 5);  };

global.___EASING.LIST[EASE.INOUT_QUAD ] = function(z){ return z < 0.5 ? ( 2 * z * z            ) : 1 - power(-2 * z + 2, 2) / 2; };
global.___EASING.LIST[EASE.INOUT_CUBIC] = function(z){ return z < 0.5 ? ( 4 * z * z * z        ) : 1 - power(-2 * z + 2, 3) / 2; };
global.___EASING.LIST[EASE.INOUT_QUART] = function(z){ return z < 0.5 ? ( 8 * z * z * z * z    ) : 1 - power(-2 * z + 2, 4) / 2; };
global.___EASING.LIST[EASE.INOUT_QUINT] = function(z){ return z < 0.5 ? (16 * z * z * z * z * z) : 1 - power(-2 * z + 2, 5) / 2; };

global.___EASING.LIST[   EASE.IN_SINE] = function(z){ return 1 - cos((z * pi)      / 2); };
...
global.___EASING.LIST[   EASE.IN_BOUNCE] = function(z){ return 1 - global.___EASING.LIST[EASE.OUT_BOUNCE](1 - z); };
...
global.___EASING.LIST[   EASE.IN_BACK] = function(z){ return     global.___EASING_C3 * z * z * z       - ___EASING_C1 * z * z; };
global.___EASING.LIST[  EASE.OUT_BACK] = function(z){ return 1 + global.___EASING_C3 * power(z - 1, 3) + ___EASING_C1 * power(z - 1, 2); };
global.___EASING.LIST[EASE.INOUT_BACK] = function(z)
{
    return z < 0.5
        ? (power(2 * z,     2) * ((global.___EASING_C2 + 1) *  z * 2      - global.___EASING_C2))      / 2
        : (power(2 * z - 2, 2) * ((global.___EASING_C2 + 1) * (z * 2 - 2) + global.___EASING_C2)  + 2) / 2;
};
